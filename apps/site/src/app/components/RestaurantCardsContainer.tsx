...
export const RestaurantCardsContainer: React.FC<
  RestaurantCardsContainerProps
> = ({ restaurants, title, subtitle }) => {
  return (
    <div className="flex flex-col justify-center gap-8 sm:gap-4 px-4 sm:px-0">
      {restaurants ? (
        <div className="flex flex-col justify-center gap-8 sm:gap-4">
          <div className="flex flex-col justify-center gap-1 sm:gap-1 max-w-sm sm:max-w-xl mx-auto w-full mt-6 sm:mt-10">
            <p className="text-center text-white text-light text-2xl sm:text-4xl flex flex-col pb-4">
              {title}
              <span className="text-xs text-[#727272] sm:text-base">
                {subtitle}
              </span>
            </p>
        ...
        <div className="relative flex w-full flex-col justify-center">
          <h2 className="text-center text-2xl italic tracking-tighter text-[#727272] sm:text-2xl">
...
export const NewRestaurantCardsContainer: React.FC<
  RestaurantCardsContainerProps
> = ({ restaurants, title, subtitle }) => {
  return (
    <div className="flex flex-col justify-center gap-8 sm:gap-4 px-4 sm:px-0">
